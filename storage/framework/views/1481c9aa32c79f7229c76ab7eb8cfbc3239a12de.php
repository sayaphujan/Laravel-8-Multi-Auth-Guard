                    ...
                    <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="d-flex py-1">
                                    <div class="my-auto">
                                        <img src="<?php echo e(asset('assets')); ?>/img/team-2.jpg" class="avatar avatar-sm  me-3 ">
                                    </div>
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="d-flex py-1">
                                    <div class="my-auto">
                                        <img src="<?php echo e(asset('assets')); ?>/img/small-logos/logo-spotify.svg"
...
<?php /**PATH D:\xampp\htdocs\kendal\resources\views/components/navbars/navs/auth.blade.php ENDPATH**/ ?>