    	...
    	<div class="row">
          <div class="col-lg-12">
	        <div class="section-title">
	          <h2>Form</h2>
          	    <p><?php echo e(__('Register Admin SIKEP')); ?></p>
	        </div>
      	  </div>
      	</div>
      </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right"><?php echo e(__('No. Telephone')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="alamat" type="alamat" class="form-control <?php $__errorArgs = ['alamat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Kecamatan')); ?></label>
                            ...
                            <div class="col-md-6">
                                <select name="kecamatan" class="form-control" id="kecamatan" aria-describedby="kecamatan">
                                    ...
                                    <?php $__currentLoopData = $kecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kecamatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option data-id="<?php echo e($kecamatan['kode']); ?>" value="<?php echo e($kecamatan['kode_cepat']); ?>"><?php echo e($kecamatan['nama']); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Desa')); ?></label>
                            ...
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                 ...
                                 <?php if(Route::has('login')): ?>
                                    <a class="btn btn-link" href="<?php echo e(url('/sikep/login/')); ?>">
                                        <?php echo e(__('Login')); ?>
...
$(document).ready(function () { 
    ...
    if(kecID){
        $.ajax({
           type:"GET",
           //url:"getdesa/"+kecID,
           url:"<?php echo e(url('/sikep/getdesa/')); ?>/"+kecID,
           dataType: 'JSON',
...
<?php echo $__env->make('sikep.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\kendal\resources\views/sikep/register.blade.php ENDPATH**/ ?>