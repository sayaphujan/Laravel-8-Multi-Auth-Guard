...
<script type="text/javascript">
  $(document).ready(function () {   
    ...
    $('#tb_user').DataTable({
     ...
     console.log("Level " +isAdmin);
    if(isAdmin === "2"){
      tblDT = $('#tb_user').DataTable();
...
<?php echo $__env->make('layouts.adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\iqbal\resources\views/trans/index.blade.php ENDPATH**/ ?>