  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo e(__('Data Transaksi Belum Terkirim')); ?></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
...
<script type="text/javascript">
  $(document).ready(function () {   
    ...
    $('#tb_user').DataTable({
        ...
        "serverSide": true,
        "order": [[1, 'desc']],
        ajax: "<?php echo e(route('trans.unsent')); ?>",
        responsive: {
          details: {
            type: 'column'
          }
...
<?php echo $__env->make('layouts.adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\iqbal\resources\views/trans/unsent.blade.php ENDPATH**/ ?>