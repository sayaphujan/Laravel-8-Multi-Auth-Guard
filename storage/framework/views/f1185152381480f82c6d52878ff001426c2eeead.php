        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><div class="gradient-button"><a href="<?php echo e(route('home')); ?>"><?php echo e(strtoupper($guard->name)); ?></a></div></li> 
            </ul>        
...
</html><?php /**PATH C:\xampp\htdocs\pta_multiple\resources\views/layouts/logchain/layout.blade.php ENDPATH**/ ?>