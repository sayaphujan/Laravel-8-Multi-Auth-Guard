...
unset($__errorArgs, $__bag); ?>" name="phone" id="phone" placeholder="No. Telepon" required="required" readonly="readonly" value="<?php echo e($trans->trans_phone); ?>">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <p style="color:green"><b><i>Terbayar</i></b> 
                            <br/><br/>
                           <img class="zoom" src="<?php echo e(asset('upload/bukti/'.$trans->payment_photo)); ?>"  width="250px" height="auto">
                          <?php endif; ?>
                        </div>
                      </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>" id="driver" aria-describedby="driver" required="required" <?php if($trans->driver_id >0 || Auth()->user()->level !=  1): ?> readonly="readonly" <?php endif; ?>>
                            <option value="">
                            <?php if($trans->driver_id == 0 &&  Auth()->user()->level !=  1): ?>
                                Menunggu Petugas
                            <?php else: ?>
                            -- Pilih Disini --
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\iqbal\resources\views/trans/detail.blade.php ENDPATH**/ ?>