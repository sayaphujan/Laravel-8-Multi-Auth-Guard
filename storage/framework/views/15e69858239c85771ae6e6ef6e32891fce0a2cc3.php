  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo e(__('Edit Data Rekening Bank')); ?></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
    </section>
      ...
      <section class="content">
        <div class="card card-outline card-info">
            <div class="card-header"></div>
                <form method="post" action="<?php echo e(route('banks.update', $bank->bank_id)); ?>" id="myForm" class="form-horizontal">
                  <div class="card-body">
                    <div class="row">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($bank->bank_name); ?>" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="owner" value="<?php echo e($bank->bank_owner); ?>" required autocomplete="owner" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="no" value="<?php echo e($bank->bank_num); ?>" required autocomplete="no">
                                    <p class="no"></p>
...
$(document).ready(function () {
    ...
    function doStuff(id){
        var uid = '<?php echo e($bank->bank_id); ?>';
        var val = $("#"+id).val();
        var key = 'no';
         $.ajax({
                  url: "<?php echo e(route('find')); ?>",
                  type: 'post',
...
<?php echo $__env->make('layouts.adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pta\resources\views/banks/edit.blade.php ENDPATH**/ ?>