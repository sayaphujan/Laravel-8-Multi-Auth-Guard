  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo e(__('Edit Data Manajemen')); ?></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
    </section>
      ...
      <section class="content">
        <div class="card card-outline card-info">
            <div class="card-header"></div>
                <form method="post" action="<?php echo e(route('owners.update', $owner->id)); ?>" id="myForm" class="form-horizontal">
                  <div class="card-body">
                    <div class="row">
                        ...
                        <?php echo method_field('PUT'); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="fullname" class="form-control" id="fullname" value="<?php echo e($owner->fullname); ?>"aria-describedby="fullname" >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" value="<?php echo e($owner->name); ?>" aria-describedby="name" >                
                                    <p class="username"></p>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="email" class="form-control" id="email" value="<?php echo e($owner->email); ?>" aria-describedby="email" >    
                                    <p class="email"></p> 
...
unset($__errorArgs, $__bag); ?>            
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="phone_number" class="form-control" id="phone_number" value="<?php echo e($owner->phone_number); ?>" aria-describedby="phone_number" >          
...
unset($__errorArgs, $__bag); ?>      
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="address" class="form-control" id="address" aria-describedby="address" required="required" value="<?php echo e($owner->address); ?>"><?php echo e($owner->address); ?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="level" class="form-control" id="level" aria-describedby="level" readonly>
                                        <option value="1" <?php echo e($owner->level == '1' ? 'selected' : ''); ?>>Admin</option>
                                        <option value="2" <?php echo e($owner->level == '2' ? 'selected' : ''); ?>>Owner</option>
                                        <option value="3" <?php echo e($owner->level == '3' ? 'selected' : ''); ?>>User</option>
                                        <option value="4" <?php echo e($owner->level == '4' ? 'selected' : ''); ?>>Driver</option>
                                    </select>    
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="card-footer">
                    ...
                    <a href="<?php echo e(route('owners')); ?>">
...
<?php echo $__env->make('layouts.adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pta_multiple\resources\views/owners/edit.blade.php ENDPATH**/ ?>