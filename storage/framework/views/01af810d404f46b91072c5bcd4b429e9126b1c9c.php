    	...
    	<div class="row">
          <div class="col-lg-12">
	        <div class="section-title">
	          <h2>Form</h2>
          	    <p><?php echo e(__('Register Admin')); ?></p>
	        </div>
      	  </div>
      	</div>
      </div>
                            ...
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                 ...
                                 <?php if(Route::has('login')): ?>
                                    <a class="btn btn-link" href="<?php echo e(url('/main/login/')); ?>">
                                        <?php echo e(__('Login')); ?>
...
<?php echo $__env->make('main.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\kendal\resources\views/auth/register.blade.php ENDPATH**/ ?>