  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo e(__('Edit Data Admin')); ?></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
    </section>
      ...
      <section class="content">
        <div class="card card-outline card-info">
            <div class="card-header"></div>
                <form method="post" action="<?php echo e(route('admins.update', $admin->id)); ?>" id="myForm" class="form-horizontal">
                  <div class="card-body">
                    <div class="row">
                        ...
                        <?php echo method_field('PUT'); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="fullname" class="form-control" id="fullname" value="<?php echo e($admin->fullname); ?>"aria-describedby="fullname" >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" value="<?php echo e($admin->name); ?>" aria-describedby="name" >                
                                    <p class="username"></p>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="email" class="form-control" id="email" value="<?php echo e($admin->email); ?>" aria-describedby="email" >    
                                    <p class="email"></p> 
...
unset($__errorArgs, $__bag); ?>            
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="phone_number" class="form-control" id="phone_number" value="<?php echo e($admin->phone_number); ?>" aria-describedby="phone_number" >          
...
unset($__errorArgs, $__bag); ?>      
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="address" class="form-control" id="address" aria-describedby="address" required="required" value="<?php echo e($admin->address); ?>"><?php echo e($admin->address); ?></textarea>
...
<?php echo $__env->make('layouts.adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pta_multiple\resources\views/admins/edit.blade.php ENDPATH**/ ?>