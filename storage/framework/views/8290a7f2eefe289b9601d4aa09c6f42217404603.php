  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo e(__('Data Transaksi Belum Terbayar')); ?></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
...
<script type="text/javascript">
  $(document).ready(function () {   
    ...
    $('#tb_user').DataTable({
        ...
        "processing": true,
        "serverSide": true,
        ajax: "<?php echo e(route('trans.unpaid')); ?>",
        responsive: {
          details: {
            type: 'column'
          }
        ...
        columns: [
            ...
            {data: 'payment_photo', render: function ( data, type, row, meta ) {
                ...
                {
                  return '<span class="badge bg-info">Pembayaran di Tempat</span>';    
                }
                else if(row.payment_photo == '')   
                {
              ...
              if(row.payment == 'Tunai')   
                {
                  return  '<div style="text-align: center">' + 
                          '<a class="show" href="trans/detail/'+row.trans_id+'" style="color:#17a2b8"><i class="fas fa-eye" title="Detail"></i></a></div>';
                }
                else if(row.payment_status == '0' && row.payment_photo == '')   
                {
                  if(isAdmin == 3){
                   return  '<div style="text-align: center">' + 
                          '<a class="show" href="trans/detail/'+row.trans_id+'/#bukti" style="color:#17a2b8"><span class="badge bg-danger">Upload Bukti Pembayaran</span></a></div>';
                  }else if(isAdmin == 1){
                      return  '<div style="text-align: center">' + 
                          '<a class="show" href="trans/detail/'+row.trans_id+'/#verifikasi" style="color:#17a2b8"><span class="badge bg-danger">Verifikasi</span></a></div>';
                  }else{
                    return  '<div style="text-align: center">' + 
                          '<a class="show" href="trans/detail/'+row.trans_id+'" style="color:#17a2b8"><i class="fas fa-eye" title="Detail"></i></a></div>';
                  }
...
<?php echo $__env->make('layouts.adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\kendal\resources\views/trans/unpaid.blade.php ENDPATH**/ ?>