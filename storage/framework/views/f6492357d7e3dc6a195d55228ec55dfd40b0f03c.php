...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
               <div class="dropdown-divider"></div>
                <a href="<?php echo e($path); ?>/profile/<?php echo e($guard->id); ?>" class="dropdown-item">
  ...
  <!-- SIDEBAR -->
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="<?php echo e(url('/')); ?>" target="_" class="brand-link">
...
<?php /**PATH C:\xampp\htdocs\pta\resources\views/layouts/adminlte/layout.blade.php ENDPATH**/ ?>