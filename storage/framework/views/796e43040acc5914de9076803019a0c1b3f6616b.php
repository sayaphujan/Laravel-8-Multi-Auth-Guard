...
<html>
  ...
  <center>
    <table style='width:680px; font-size:8pt; font-family:calibri; border-collapse: collapse;' border = '0'>
      <td><img src="<?php echo e(asset('assets/dist/img/pdamkendal.png')); ?>" width="50px"></td>
      ...
      <td style='vertical-align:top' width='30%' align='left'>
        ...
        No Trans. : 4</br>
        Tanggal :<?php echo e(date('d-m-Y H:i', strtotime($trans->created_at))); ?></br>
      </td>
    </table>
<hr/>
  ...
  <script src="https://code.jquery.com/ui/1.13.0/jquery-ui.js"></script><?php /**PATH C:\xampp\htdocs\pta_multiple\resources\views/trans/print.blade.php ENDPATH**/ ?>