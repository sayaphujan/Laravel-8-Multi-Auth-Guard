...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" <?php echo e(route('home')); ?> ">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php echo e($activePage == 'home' ? ' active bg-gradient-primary' : ''); ?> "
...
<?php /**PATH D:\xampp\htdocs\kendal\resources\views/components/navbars/sidebar.blade.php ENDPATH**/ ?>