        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><div class="gradient-button"><a href="<?php echo e(route('home')); ?>"><?php echo e(strtoupper(Auth::user()->name)); ?></a></div></li>
              <?php endif; ?>
...
</html><?php /**PATH D:\xampp\htdocs\iqbal\resources\views/layouts/chain/layout.blade.php ENDPATH**/ ?>