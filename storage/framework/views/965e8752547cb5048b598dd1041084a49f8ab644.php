...
<head>
  ...
  <!-- Zoom Image -->
  <link href="<?php echo e(asset('assets/plugins/lightbox-zoom/zoomify.css')); ?>" rel="stylesheet" type="text/css">
  <style>
...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
               <div class="dropdown-divider"></div>
                <a href="/profile/<?php echo e($guard->id); ?>" class="dropdown-item">
  ...
  <!-- SIDEBAR -->
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="<?php echo e(route('portal')); ?>" target="_" class="brand-link">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <?php if(empty($guard->photo)): ?>
            <img src="<?php echo e(asset('assets/dist/img/user-160x160.jpg')); ?>" class="img-circle elevation-2" alt="User Image">
            <?php else: ?>
            <img src="<?php echo e(asset('upload/profile/'.$guard->photo)); ?>" class="img-circle elevation-2" alt="User Image">
            <?php endif; ?>
          </div>
          <div class="info">
            <a href="#" class="d-block"><?php echo e(strtoupper($guard->name)); ?></a>
          </div>
        </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="margin-left: 25px;">
                ...
                <li class="nav-item">
                  <a href="<?php echo e(url('/unpaid')); ?>" class="nav-link">
                ...
                <li class="nav-item">
                  <a href="<?php echo e(url('/unverified')); ?>" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                ...
                <?php if($guard->level == '3'): ?>
                <li class="nav-item">
                  <a href="<?php echo e(url('/paid')); ?>" class="nav-link">
                ...
                <?php if($guard->level == '4'): ?>
                <li class="nav-item">
                  <a href="<?php echo e(url('/unsent')); ?>" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Belum Terkirim</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo e(url('/sent')); ?>" class="nav-link">
            ...
            <?php if($guard->level == 1 || $guard->level == 2 ): ?>
            <li class="nav-item">
            ...
            <?php if($guard->level == 1 || $guard-> level == 2): ?>
            <li class="nav-item">
              <a href="<?php echo e(url('/admins')); ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?php echo e(url('/owners')); ?>" class="nav-link">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo e(route('cetak')); ?>" target="_blank">
                    <?php echo csrf_field(); ?>
  ...
  <script src="<?php echo e(asset('assets/plugins/lightbox-zoom/zoomify.js')); ?>"></script>
  <!-- AdminLTE -->
...
<?php /**PATH C:\xampp\htdocs\pta_multiple\resources\views/layouts/adminlte/layout.blade.php ENDPATH**/ ?>