  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo e(__('Data Transaksi Terbayar')); ?></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
...
<script type="text/javascript">
  $(document).ready(function () {   
    ...
    $('#tb_user').DataTable({
        ...
        "processing": true,
        "serverSide": true,
        ajax: "<?php echo e(route('trans.paid')); ?>",
        responsive: {
          details: {
            type: 'column'
          }
...
<?php echo $__env->make('layouts.adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\kendal\resources\views/trans/paid.blade.php ENDPATH**/ ?>