...
class TransController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('trans.index',compact('guard'));
    }
    ...
    public function paid(Request $request)
    {
        ...
        return view('trans.paid',compact('guard'));
    }
    ...
    public function unpaid(Request $request)
    {
        ...
        return view('trans.unpaid',compact('guard'));
    }
    ...
    public function unverified(Request $request)
    {
        ...
        return view('trans.unverified',compact('guard'));
    }
    ...
    public function sent(Request $request)
    {
        ...
        return view('trans.sent',compact('guard'));
    }
    ...
    public function unsent(Request $request)
    {
        ...
        return view('trans.unsent',compact('guard'));
    }
    ...
    public function print($order_id)
    {
        ...
        return view('trans.print', compact('trans','guard','price','bank'));
    }
