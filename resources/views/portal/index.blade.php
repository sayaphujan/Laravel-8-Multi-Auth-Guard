@extends('layouts.logchain.layout')
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="col-lg-6 offset-lg-3">
              <form method="POST" action="{{ route('portal.order') }}" id="contactForm" name="contactForm" class="contactForm" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mt-3 mb-3">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      @if($guard)
                      <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Nama Pemohon" readonly="readonly" value="{{ strtoupper($guard->name) }}">
                      @endif
                      @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="No. Telepon" required="required" value="{{  $guard->phone_number }}">
                ...
                <div class="row mt-3 mb-3">
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" id="address" placeholder="Alamat Pengiriman" required="required" value="{{  strtoupper($guard->address)  }}">
