              ...
              <form method="POST" action="{{ route('pesan') }}" id="contactForm" name="contactForm" class="contactForm" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="No. Telepon" required="required" value="{{  $guard->phone_numbeer }}">
