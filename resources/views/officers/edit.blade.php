      ...
      <section class="content">
        <div class="card card-outline card-info">
            <div class="card-header"></div>
                <form method="post" action="{{ route('officers.update', $officer->id) }}" id="myForm" class="form-horizontal">
                  <div class="card-body">
                    <div class="row">
                        ...
                        @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="fullname" class="form-control" id="fullname" value="{{ $officer->fullname }}"aria-describedby="fullname" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" value="{{ $officer->name }}" aria-describedby="name" >                
                                    <p class="username"></p>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="email" class="form-control" id="email" value="{{ $officer->email }}" aria-describedby="email" >    
                                    <p class="email"></p> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="phone_number" class="form-control" id="phone_number" value="{{ $officer->phone_number }}" aria-describedby="phone_number" >          
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="address" class="form-control" id="address" aria-describedby="address" required="required" value="{{ $officer->address }}">{{ $officer->address }}</textarea>
