...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
               <div class="dropdown-divider"></div>
                <a href="/profile/{{ $guard->id }}" class="dropdown-item">
  ...
  <!-- SIDEBAR -->
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="{{ route('portal') }}" target="_" class="brand-link">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            @if(empty($guard->photo))
            <img src="{{ asset('assets/dist/img/user-160x160.jpg') }}" class="img-circle elevation-2" alt="User Image">
            @else
            <img src="{{ asset('upload/profile/'.$guard->photo) }}" class="img-circle elevation-2" alt="User Image">
            @endif
          </div>
          <div class="info">
            <a href="#" class="d-block">{{ strtoupper($guard->name) }}</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            @if ($guard->level == 1 || $guard->level == 2 )
            <li class="nav-item">
