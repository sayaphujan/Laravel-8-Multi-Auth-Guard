  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">{{ __('Edit Data Admin') }}</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
    </section>
      ...
      <section class="content">
        <div class="card card-outline card-info">
            <div class="card-header"></div>
                <form method="post" action="{{ route('admins.update', $admin->id) }}" id="myForm" class="form-horizontal">
                  <div class="card-body">
                    <div class="row">
                        ...
                        @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="fullname" class="form-control" id="fullname" value="{{ $admin->fullname }}"aria-describedby="fullname" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" value="{{ $admin->name }}" aria-describedby="name" >                
                                    <p class="username"></p>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="phone_number" class="form-control" id="phone_number" value="{{ $admin->phone_number }}" aria-describedby="phone_number" >          
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="address" class="form-control" id="address" aria-describedby="address" required="required" value="{{ $admin->address }}">{{ $admin->address }}</textarea>
