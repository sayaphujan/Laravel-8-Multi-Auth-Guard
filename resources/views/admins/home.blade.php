            ...
            <div class="col-12">
                <div class="card card-row card-primary mb-3" style="width: 70vw!important;">
                    ...
                    <div class="card-body" style="padding: 0.75rem 1.25rem;">
                        ...
                        <p>Selamat Datang <b>{{ ucfirst(auth('admin')->user()->name) }}</b></p>
                        <p>Anda terdaftar sebagai @if (auth('admin')->user()->level == 1)
                            <b>{{ 'ADMIN' }}</b>
                        @elseif (auth('admin')->user()->level == 2)
                            <b>{{ 'OWNER' }}</b>
                        @elseif (auth('admin')->user()->level == 3)
                            <b>{{ 'CUSTOMER' }}</b>
                         @elseif (auth('admin')->user()->level == 4)
                            <b>{{ 'DRIVER' }}</b>
                        @endif</p>
                    </div>
                </div>
