  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">{{ __('Edit Data Manajemen') }}</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
    </section>
      ...
      <section class="content">
        <div class="card card-outline card-info">
            <div class="card-header"></div>
                <form method="post" action="{{ route('owners.update', $owner->id) }}" id="myForm" class="form-horizontal">
                  <div class="card-body">
                    <div class="row">
                        ...
                        @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="fullname" class="form-control" id="fullname" value="{{ $owner->fullname }}"aria-describedby="fullname" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" value="{{ $owner->name }}" aria-describedby="name" >                
                                    <p class="username"></p>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="email" class="form-control" id="email" value="{{ $owner->email }}" aria-describedby="email" >    
                                    <p class="email"></p> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="phone_number" class="form-control" id="phone_number" value="{{ $owner->phone_number }}" aria-describedby="phone_number" >          
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="address" class="form-control" id="address" aria-describedby="address" required="required" value="{{ $owner->address }}">{{ $owner->address }}</textarea>
