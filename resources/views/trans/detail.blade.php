                  ...
                  <div class="card-body">
                    ...
                    <div class="row mt-3 mb-3">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="No. Telepon" readonly="readonly" value="{{ $trans->trans_phone }}">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row mt-3 mb-3">
                      <div class="col-md-12">
                        ...
                        <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" id="address" placeholder="Alamat Pengiriman" readonly="readonly" value="{{ $trans->loc_address1 }}">
                      </div>
                    </div>
...
-->
                        ...
                        <div class="form-group">
                          ...
                          @else
                           ...
                           <img class="zoom" src="{{ asset('upload/bukti/'.$trans->payment_photo) }}"  width="250px" height="auto"><br/><br/>
                              @if($guard->level == 3 && $trans->payment_status != 1)
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="driver" class="form-control @error('driver') is-invalid @enderror" aria-describedby="driver" required="required" @if($trans->driver_id >0 || $guard->level !=  1) readonly="readonly" @endif>
                            <option value="">
                            @if($trans->driver_id == 0 &&  $guard->level !=  1)
                                Menunggu Petugas
                            @else
                            -- Pilih Disini --
                            @endif
